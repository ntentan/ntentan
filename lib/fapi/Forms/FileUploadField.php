...
class FileUploadField extends Field
{
	...
	public function setJsExpression($expression)
	{
	...
	public function render()
	{
		...
		$ret .= "<input $attributes type='file' class='fapi-fileupload' onchange=\"fapiStartUpload(this,this.form,'{$this->script}','{$this->jsExpression}')\" />";
		return $ret;
	}
}
?>
